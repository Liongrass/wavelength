...
| [`tapassets`](tapassets/) | Adapts tap-sdk custom-anchor transitions to Ark structures: journaled caller-funded asset batch outputs plus asset-aware VTXO tree materialization |
