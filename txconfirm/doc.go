...
// rejection of the zero-fee anchor parent, a mempool-full backend, or a
// conflicting child with a reported replacement fee floor keep retrying.
// After Config.BroadcastFailureAlertThreshold consecutive failures
