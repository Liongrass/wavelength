...
func (x *VTXO) GetSettlement() *VTXOSettlement {
	if x != nil {
		return x.Settlement
	}
	return nil
...
func (x *VTXOSettlement) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type RefreshVTXOsResponse struct {
	...
	FeeEstimate   *RefreshFeeEstimate `protobuf:"bytes,3,opt,name=fee_estimate,json=feeEstimate,proto3" json:"fee_estimate,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RefreshVTXOsResponse) GetFeeEstimate() *RefreshFeeEstimate {
	if x != nil {
...
type RefreshFeeEstimate struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	EstimatedTotalFeeSat *int64 `protobuf:"varint,1,opt,name=estimated_total_fee_sat,json=estimatedTotalFeeSat,proto3,oneof" json:"estimated_total_fee_sat,omitempty"`
	...
	Outpoints []*OutpointFeeEstimate `protobuf:"bytes,2,rep,name=outpoints,proto3" json:"outpoints,omitempty"`
	...
	// inputs forfeits it.
	FreeRefreshEligible bool `protobuf:"varint,3,opt,name=free_refresh_eligible,json=freeRefreshEligible,proto3" json:"free_refresh_eligible,omitempty"`
	...
	// rather than zero.
	EstimateError string `protobuf:"bytes,4,opt,name=estimate_error,json=estimateError,proto3" json:"estimate_error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RefreshFeeEstimate) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RefreshFeeEstimate) GetEstimatedTotalFeeSat() int64 {
	if x != nil && x.EstimatedTotalFeeSat != nil {
		return *x.EstimatedTotalFeeSat
	}
	return 0
}
...
func (x *RefreshFeeEstimate) GetFreeRefreshEligible() bool {
	if x != nil {
		return x.FreeRefreshEligible
	}
	return false
}

func (x *RefreshFeeEstimate) GetEstimateError() string {
	if x != nil {
...
type OutpointFeeEstimate struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	LiquidityFeeSat int64 `protobuf:"varint,4,opt,name=liquidity_fee_sat,json=liquidityFeeSat,proto3" json:"liquidity_fee_sat,omitempty"`
	...
	MarginSat int64 `protobuf:"varint,6,opt,name=margin_sat,json=marginSat,proto3" json:"margin_sat,omitempty"`
	...
	TotalFeeSat int64 `protobuf:"varint,7,opt,name=total_fee_sat,json=totalFeeSat,proto3" json:"total_fee_sat,omitempty"`
	...
	InFreeRefreshWindow bool `protobuf:"varint,8,opt,name=in_free_refresh_window,json=inFreeRefreshWindow,proto3" json:"in_free_refresh_window,omitempty"`
	...
	BelowDustWarning bool `protobuf:"varint,9,opt,name=below_dust_warning,json=belowDustWarning,proto3" json:"below_dust_warning,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *OutpointFeeEstimate) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *OutpointFeeEstimate) GetAmountSat() int64 {
	if x != nil {
		return x.AmountSat
	}
	return 0
...
func (x *OutpointFeeEstimate) GetRemainingBlocks() uint32 {
	if x != nil {
...
func (x *OutpointFeeEstimate) GetLiquidityFeeSat() int64 {
	if x != nil {
...
func (x *OutpointFeeEstimate) GetOnchainShareSat() int64 {
	if x != nil {
...
func (x *OutpointFeeEstimate) GetMarginSat() int64 {
	if x != nil {
		return x.MarginSat
	}
	return 0
...
func (x *OutpointFeeEstimate) GetTotalFeeSat() int64 {
	if x != nil {
...
func (x *OutpointFeeEstimate) GetInFreeRefreshWindow() bool {
	if x != nil {
		return x.InFreeRefreshWindow
	}
	return false
}

func (x *OutpointFeeEstimate) GetBelowDustWarning() bool {
	if x != nil {
...
type RegisterPolicyReceiveScriptRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// pk_script is the exact output the policy must reconstruct.
	PkScript []byte `protobuf:"bytes,1,opt,name=pk_script,json=pkScript,proto3" json:"pk_script,omitempty"`
	// policy_template is the canonical encoded Ark policy.
	PolicyTemplate []byte `protobuf:"bytes,2,opt,name=policy_template,json=policyTemplate,proto3" json:"policy_template,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *RegisterPolicyReceiveScriptRequest) Reset() {
	*x = RegisterPolicyReceiveScriptRequest{}
	mi := &file_daemon_proto_msgTypes[129]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RegisterPolicyReceiveScriptRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterPolicyReceiveScriptRequest) ProtoMessage() {}

func (x *RegisterPolicyReceiveScriptRequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[129]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterPolicyReceiveScriptRequest.ProtoReflect.Descriptor instead.
func (*RegisterPolicyReceiveScriptRequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{129}
}

func (x *RegisterPolicyReceiveScriptRequest) GetPkScript() []byte {
	if x != nil {
		return x.PkScript
	}
	return nil
...
func (x *RegisterPolicyReceiveScriptRequest) GetPolicyTemplate() []byte {
	if x != nil {
		return x.PolicyTemplate
	}
	return nil
...
type RegisterPolicyReceiveScriptResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// expires_at_unix_s is the bounded registration retention deadline.
	ExpiresAtUnixS uint64 `protobuf:"varint,1,opt,name=expires_at_unix_s,json=expiresAtUnixS,proto3" json:"expires_at_unix_s,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *RegisterPolicyReceiveScriptResponse) Reset() {
	*x = RegisterPolicyReceiveScriptResponse{}
	mi := &file_daemon_proto_msgTypes[130]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RegisterPolicyReceiveScriptResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterPolicyReceiveScriptResponse) ProtoMessage() {}

func (x *RegisterPolicyReceiveScriptResponse) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[130]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterPolicyReceiveScriptResponse.ProtoReflect.Descriptor instead.
func (*RegisterPolicyReceiveScriptResponse) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{130}
}

func (x *RegisterPolicyReceiveScriptResponse) GetExpiresAtUnixS() uint64 {
	if x != nil {
		return x.ExpiresAtUnixS
	}
	return 0
...
const file_daemon_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x1f.waverpc.MacaroonPermissionListR\x05value:\x028\x01\"j\n" +
	"\"RegisterPolicyReceiveScriptRequest\x12\x1b\n" +
	"\tpk_script\x18\x01 \x01(\fR\bpkScript\x12'\n" +
	"\x0fpolicy_template\x18\x02 \x01(\fR\x0epolicyTemplate\"P\n" +
	"#RegisterPolicyReceiveScriptResponse\x12)\n" +
	"\x11expires_at_unix_s\x18\x01 \x01(\x04R\x0eexpiresAtUnixS*\x8d\x01\n" +
	...
	"\x12\x1f\n" +
	"\x1bVHTLC_RECOVERY_STATE_FAILED\x10\v2\xaf!\n" +
	"\rDaemonService\x12<\n" +
	...
	"\x0fReceiveAuthECDH\x12\x1f.waverpc.ReceiveAuthECDHRequest\x1a .waverpc.ReceiveAuthECDHResponse\x12x\n" +
	"\x1bRegisterPolicyReceiveScript\x12+.waverpc.RegisterPolicyReceiveScriptRequest\x1a,.waverpc.RegisterPolicyReceiveScriptResponse\x12o\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(*RegisterPolicyReceiveScriptRequest)(nil),                     // 140: waverpc.RegisterPolicyReceiveScriptRequest
	(*RegisterPolicyReceiveScriptResponse)(nil),                    // 141: waverpc.RegisterPolicyReceiveScriptResponse
	nil, // 142: waverpc.LeaveVTXOsRequest.DestinationsEntry
	nil, // 143: waverpc.ListPermissionsResponse.MethodPermissionsEntry
}
var file_daemon_proto_depIdxs = []int32{
	...
	142, // 35: waverpc.LeaveVTXOsRequest.destinations:type_name -> waverpc.LeaveVTXOsRequest.DestinationsEntry
	...
	143, // 71: waverpc.ListPermissionsResponse.method_permissions:type_name -> waverpc.ListPermissionsResponse.MethodPermissionsEntry
	...
	140, // 86: waverpc.DaemonService.RegisterPolicyReceiveScript:input_type -> waverpc.RegisterPolicyReceiveScriptRequest
	39,  // 87: waverpc.DaemonService.GetIndexedVTXOByPkScript:input_type -> waverpc.GetIndexedVTXOByPkScriptRequest
	41,  // 88: waverpc.DaemonService.GetVTXOExpiryInfo:input_type -> waverpc.GetVTXOExpiryInfoRequest
	43,  // 89: waverpc.DaemonService.GetIndexedOORSessionByTxid:input_type -> waverpc.GetIndexedOORSessionByTxidRequest
	46,  // 90: waverpc.DaemonService.SendVTXO:input_type -> waverpc.SendVTXORequest
	48,  // 91: waverpc.DaemonService.SendOOR:input_type -> waverpc.SendOORRequest
	52,  // 92: waverpc.DaemonService.PrepareOOR:input_type -> waverpc.PrepareOORRequest
	55,  // 93: waverpc.DaemonService.SignOORCustomInput:input_type -> waverpc.SignOORCustomInputRequest
	57,  // 94: waverpc.DaemonService.SignVTXOForfeit:input_type -> waverpc.SignVTXOForfeitRequest
	61,  // 95: waverpc.DaemonService.RefreshVTXOs:input_type -> waverpc.RefreshVTXOsRequest
	67,  // 96: waverpc.DaemonService.RefreshCustomVTXOs:input_type -> waverpc.RefreshCustomVTXOsRequest
	70,  // 97: waverpc.DaemonService.ListPendingForfeitParticipantSignatureRequests:input_type -> waverpc.ListPendingForfeitParticipantSignatureRequestsRequest
	73,  // 98: waverpc.DaemonService.SubmitForfeitParticipantSignatures:input_type -> waverpc.SubmitForfeitParticipantSignaturesRequest
	76,  // 99: waverpc.DaemonService.LeaveVTXOs:input_type -> waverpc.LeaveVTXOsRequest
	78,  // 100: waverpc.DaemonService.SendOnChain:input_type -> waverpc.SendOnChainRequest
	80,  // 101: waverpc.DaemonService.Board:input_type -> waverpc.BoardRequest
	82,  // 102: waverpc.DaemonService.JoinNextRound:input_type -> waverpc.JoinNextRoundRequest
	84,  // 103: waverpc.DaemonService.SweepBoardingUTXOs:input_type -> waverpc.SweepBoardingUTXOsRequest
	87,  // 104: waverpc.DaemonService.ListBoardingSweeps:input_type -> waverpc.ListBoardingSweepsRequest
	93,  // 105: waverpc.DaemonService.ListRounds:input_type -> waverpc.ListRoundsRequest
	94,  // 106: waverpc.DaemonService.GetRound:input_type -> waverpc.GetRoundRequest
	97,  // 107: waverpc.DaemonService.WatchRounds:input_type -> waverpc.WatchRoundsRequest
	100, // 108: waverpc.DaemonService.ListOORSessions:input_type -> waverpc.ListOORSessionsRequest
	102, // 109: waverpc.DaemonService.GetOORSession:input_type -> waverpc.GetOORSessionRequest
	104, // 110: waverpc.DaemonService.EstimateFee:input_type -> waverpc.EstimateFeeRequest
	106, // 111: waverpc.DaemonService.GetFeeHistory:input_type -> waverpc.GetFeeHistoryRequest
	109, // 112: waverpc.DaemonService.ListTransactions:input_type -> waverpc.ListTransactionsRequest
	112, // 113: waverpc.DaemonService.Unroll:input_type -> waverpc.UnrollRequest
	114, // 114: waverpc.DaemonService.GetUnrollStatus:input_type -> waverpc.GetUnrollStatusRequest
	119, // 115: waverpc.DaemonService.ArmVHTLCRecovery:input_type -> waverpc.ArmVHTLCRecoveryRequest
	121, // 116: waverpc.DaemonService.EscalateVHTLCRecovery:input_type -> waverpc.EscalateVHTLCRecoveryRequest
	123, // 117: waverpc.DaemonService.CancelVHTLCRecovery:input_type -> waverpc.CancelVHTLCRecoveryRequest
	125, // 118: waverpc.DaemonService.GetVHTLCRecoveryStatus:input_type -> waverpc.GetVHTLCRecoveryStatusRequest
	127, // 119: waverpc.DaemonService.ListVHTLCRecoveries:input_type -> waverpc.ListVHTLCRecoveriesRequest
	130, // 120: waverpc.DaemonService.SignOutSwapHtlcAck:input_type -> waverpc.SignOutSwapHtlcAckRequest
	132, // 121: waverpc.DaemonService.SignCreditAccountAuthorization:input_type -> waverpc.SignCreditAccountAuthorizationRequest
	135, // 122: waverpc.MacaroonService.BakeMacaroon:input_type -> waverpc.BakeMacaroonRequest
	138, // 123: waverpc.MacaroonService.ListPermissions:input_type -> waverpc.ListPermissionsRequest
	...
	26,  // 129: waverpc.DaemonService.ListVTXOs:output_type -> waverpc.ListVTXOsResponse
	28,  // 130: waverpc.DaemonService.NewAddress:output_type -> waverpc.NewAddressResponse
	30,  // 131: waverpc.DaemonService.NewReceiveScript:output_type -> waverpc.NewReceiveScriptResponse
	32,  // 132: waverpc.DaemonService.ReceiveAuthKey:output_type -> waverpc.ReceiveAuthKeyResponse
	34,  // 133: waverpc.DaemonService.SignReceiveAuthMessage:output_type -> waverpc.SignReceiveAuthMessageResponse
	36,  // 134: waverpc.DaemonService.SignReceiveAuthMessageCompact:output_type -> waverpc.SignReceiveAuthMessageCompactResponse
	38,  // 135: waverpc.DaemonService.ReceiveAuthECDH:output_type -> waverpc.ReceiveAuthECDHResponse
	141, // 136: waverpc.DaemonService.RegisterPolicyReceiveScript:output_type -> waverpc.RegisterPolicyReceiveScriptResponse
	40,  // 137: waverpc.DaemonService.GetIndexedVTXOByPkScript:output_type -> waverpc.GetIndexedVTXOByPkScriptResponse
	42,  // 138: waverpc.DaemonService.GetVTXOExpiryInfo:output_type -> waverpc.GetVTXOExpiryInfoResponse
	44,  // 139: waverpc.DaemonService.GetIndexedOORSessionByTxid:output_type -> waverpc.GetIndexedOORSessionByTxidResponse
	47,  // 140: waverpc.DaemonService.SendVTXO:output_type -> waverpc.SendVTXOResponse
	51,  // 141: waverpc.DaemonService.SendOOR:output_type -> waverpc.SendOORResponse
	54,  // 142: waverpc.DaemonService.PrepareOOR:output_type -> waverpc.PrepareOORResponse
	56,  // 143: waverpc.DaemonService.SignOORCustomInput:output_type -> waverpc.SignOORCustomInputResponse
	58,  // 144: waverpc.DaemonService.SignVTXOForfeit:output_type -> waverpc.SignVTXOForfeitResponse
	62,  // 145: waverpc.DaemonService.RefreshVTXOs:output_type -> waverpc.RefreshVTXOsResponse
	68,  // 146: waverpc.DaemonService.RefreshCustomVTXOs:output_type -> waverpc.RefreshCustomVTXOsResponse
	71,  // 147: waverpc.DaemonService.ListPendingForfeitParticipantSignatureRequests:output_type -> waverpc.ListPendingForfeitParticipantSignatureRequestsResponse
	74,  // 148: waverpc.DaemonService.SubmitForfeitParticipantSignatures:output_type -> waverpc.SubmitForfeitParticipantSignaturesResponse
	77,  // 149: waverpc.DaemonService.LeaveVTXOs:output_type -> waverpc.LeaveVTXOsResponse
	79,  // 150: waverpc.DaemonService.SendOnChain:output_type -> waverpc.SendOnChainResponse
	81,  // 151: waverpc.DaemonService.Board:output_type -> waverpc.BoardResponse
	83,  // 152: waverpc.DaemonService.JoinNextRound:output_type -> waverpc.JoinNextRoundResponse
	86,  // 153: waverpc.DaemonService.SweepBoardingUTXOs:output_type -> waverpc.SweepBoardingUTXOsResponse
	90,  // 154: waverpc.DaemonService.ListBoardingSweeps:output_type -> waverpc.ListBoardingSweepsResponse
	96,  // 155: waverpc.DaemonService.ListRounds:output_type -> waverpc.ListRoundsResponse
	95,  // 156: waverpc.DaemonService.GetRound:output_type -> waverpc.GetRoundResponse
	98,  // 157: waverpc.DaemonService.WatchRounds:output_type -> waverpc.WatchRoundsResponse
	101, // 158: waverpc.DaemonService.ListOORSessions:output_type -> waverpc.ListOORSessionsResponse
	103, // 159: waverpc.DaemonService.GetOORSession:output_type -> waverpc.GetOORSessionResponse
	105, // 160: waverpc.DaemonService.EstimateFee:output_type -> waverpc.EstimateFeeResponse
	108, // 161: waverpc.DaemonService.GetFeeHistory:output_type -> waverpc.GetFeeHistoryResponse
	111, // 162: waverpc.DaemonService.ListTransactions:output_type -> waverpc.ListTransactionsResponse
	113, // 163: waverpc.DaemonService.Unroll:output_type -> waverpc.UnrollResponse
	118, // 164: waverpc.DaemonService.GetUnrollStatus:output_type -> waverpc.GetUnrollStatusResponse
	120, // 165: waverpc.DaemonService.ArmVHTLCRecovery:output_type -> waverpc.ArmVHTLCRecoveryResponse
	122, // 166: waverpc.DaemonService.EscalateVHTLCRecovery:output_type -> waverpc.EscalateVHTLCRecoveryResponse
	124, // 167: waverpc.DaemonService.CancelVHTLCRecovery:output_type -> waverpc.CancelVHTLCRecoveryResponse
	126, // 168: waverpc.DaemonService.GetVHTLCRecoveryStatus:output_type -> waverpc.GetVHTLCRecoveryStatusResponse
	128, // 169: waverpc.DaemonService.ListVHTLCRecoveries:output_type -> waverpc.ListVHTLCRecoveriesResponse
	131, // 170: waverpc.DaemonService.SignOutSwapHtlcAck:output_type -> waverpc.SignOutSwapHtlcAckResponse
	133, // 171: waverpc.DaemonService.SignCreditAccountAuthorization:output_type -> waverpc.SignCreditAccountAuthorizationResponse
	136, // 172: waverpc.MacaroonService.BakeMacaroon:output_type -> waverpc.BakeMacaroonResponse
	139, // 173: waverpc.MacaroonService.ListPermissions:output_type -> waverpc.ListPermissionsResponse
