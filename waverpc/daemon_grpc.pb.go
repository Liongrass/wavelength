...
const (
	...
	DaemonService_RegisterPolicyReceiveScript_FullMethodName                    = "/waverpc.DaemonService/RegisterPolicyReceiveScript"
...
type DaemonServiceClient interface {
	...
	// RegisterPolicyReceiveScript proves this daemon participates in a custom
	...
	RegisterPolicyReceiveScript(ctx context.Context, in *RegisterPolicyReceiveScriptRequest, opts ...grpc.CallOption) (*RegisterPolicyReceiveScriptResponse, error)
...
func (c *daemonServiceClient) RegisterPolicyReceiveScript(ctx context.Context, in *RegisterPolicyReceiveScriptRequest, opts ...grpc.CallOption) (*RegisterPolicyReceiveScriptResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterPolicyReceiveScriptResponse)
	err := c.cc.Invoke(ctx, DaemonService_RegisterPolicyReceiveScript_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaemonServiceServer interface {
	...
	// Taproot policy and durably registers it with the operator. A retry
	// updates the same principal/script binding. No funding is performed.
	RegisterPolicyReceiveScript(context.Context, *RegisterPolicyReceiveScriptRequest) (*RegisterPolicyReceiveScriptResponse, error)
	// GetIndexedVTXOByPkScript queries the authoritative indexer for the
	// first VTXO matching the given script and status filter.
...
func (UnimplementedDaemonServiceServer) RegisterPolicyReceiveScript(context.Context, *RegisterPolicyReceiveScriptRequest) (*RegisterPolicyReceiveScriptResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterPolicyReceiveScript not implemented")
}
...
func _DaemonService_RegisterPolicyReceiveScript_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterPolicyReceiveScriptRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServiceServer).RegisterPolicyReceiveScript(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonService_RegisterPolicyReceiveScript_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServiceServer).RegisterPolicyReceiveScript(ctx, req.(*RegisterPolicyReceiveScriptRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DaemonService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegisterPolicyReceiveScript",
			Handler:    _DaemonService_RegisterPolicyReceiveScript_Handler,
		},
		{
